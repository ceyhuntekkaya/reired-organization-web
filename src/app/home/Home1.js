                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-3">
                            <div className="header-top-left">
                                <ul>
                                    <li className="has-dropdown"><a href="index.html#">USD</a>
                                        <ul>
                                            <li><a href="index.html#">URO</a></li>
                                            <li><a href="index.html#">FJD</a></li>
                                            <li><a href="index.html#">GBP</a></li>
                                        </ul>
                                    </li>
                                    <li className="has-dropdown"><a href="index.html#">English</a>
                                        <ul>
                        ...
                        <div className="row navigation-bg">
                            <div className="col-lg-2 col-sm-4 col-4">
                                ...
                                <div className="site-logo">
                                    <a href="index.html"><img src="img/logo.png" alt="GENE"/></a>
                                </div>
                                <!-- End site logo -->
                            </div>
                            ...
                            <div className="col-lg-2 col-sm-4 col-6 order-one">
                                ...
                                <div className="login-cart">
                                    <ul>
                                        <li><a href="index.html#"><i className="far fa-user"></i>LOGIN</a></li>
                                        <li className="cart-mega">
                                            <!-- Header Cart Start -->
                                            <a href="index.html#ec-side-cart" className="ec-header-btn ec-side-toggle">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="about-content">
                                <p>We are a family-owned company, and getting to know you is our biggest priority.
                                    ...
                                    the way to do it.</p>
                                <a href="index.html#" className="btn btn-theme">Get To Know Our Values</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Hiking & Trekking</h5></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Cycling Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Family Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Wildlife Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Polar Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Food Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>ruise Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <a href="index.html#"><h5>Beach Tours</h5></a>
                                    <p>Responsible travel has always been at the core of what we do.</p>
                                </div>
                            </div>
                            <!-- end single adventure -->
                    ...
                    <div className="row">
                            ...
                            <div className="selling-tips-wrap">
                                ...
                                <div className="single-selling-tips section-title">
                                    ...
                                    <p>It’s time to pack your bags and get ready for your next adventure. Check out the
                                        ...
                                        beautiful world.</p>
                                    <a href="index.html#" className="btn btn-theme mt-30">See all the tours we're
                                        running</a>
                                </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    ...
                                    <a href="index.html#"><h6>Adventure Cycling in Peru</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index.html#"><h6>Best of Spain & Portugal</h6></a>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index.html#"><h6>Polar Tours</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index.html#"><h6>Food Tours</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index.html#"><h6>ruise Tours</h6></a>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-post-blog">
                                ...
                                <div className="post-blog-content">
                                    <a href="index.html#"><h4>Will yacht tourism set to boom post-pandemic?</h4></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-post-blog">
                                ...
                                <div className="post-blog-content">
                                    <a href="index.html#"><h4>Travel will bounce back sooner than expected</h4></a>
                                    <p>Currently, the yacht charter market is predicted to register a CAGR of about 4%
                                        during the forecast period (2020 - 2025).</p>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-post-blog">
                                ...
                                <div className="post-blog-content">
                                    <a href="index.html#"><h4>Darjeeling & Kalimpong Open Doors for Tourists</h4></a>
                                    <p>Currently, the yacht charter market is predicted to register a CAGR of about 4%
                                        during the forecast period (2020 - 2025).</p>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-post-blog">
                                ...
                                <div className="post-blog-content">
                                    <a href="index.html#"><h4>Bir Billing Paragliding to Start from 15th Sep.</h4></a>
                                    <p>Currently, the yacht charter market is predicted to register a CAGR of about 4%
                                        during the forecast period (2020 - 2025).</p>
                                </div>
                            </div>
                            ...
                            <div className="single-guide">
                                <div className="guide-thumb">
                                    ...
                                    <div className="guide-content">
                                        ...
                                        <a href="index.html#"><h4>Chris Kearney</h4></a>
                                        <ul>
                            ...
                            <div className="single-guide">
                                <div className="guide-thumb">
                                    ...
                                    <div className="guide-content">
                                        ...
                                        <a href="index.html#"><h4>Megan Devenish</h4></a>
                                        <ul>
                                            <li><a href="index.html#"><i className="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.html#"><i className="fab fa-twitter"></i></a></li>
                                            <li><a href="index.html#"><i className="fab fa-instagram"></i></a></li>
                            ...
                            <div className="single-guide">
                                <div className="guide-thumb">
                                    ...
                                    <div className="guide-content">
                                        ...
                                        <a href="index.html#"><h4>Dan Bloomfield</h4></a>
                                        <ul>
                                            <li><a href="index.html#"><i className="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.html#"><i className="fab fa-twitter"></i></a></li>
                                            <li><a href="index.html#"><i className="fab fa-instagram"></i></a></li>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-2 col-sm-3">
                            ...
                            <div className="widget quick-link-widget">
                                <h3>Quick Links</h3>
                                <ul>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>About Us</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Why Travel With Us?</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Guides & Staff</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Contact Us</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>We Are Hiring</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Our Core Values</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-2 col-sm-3">
                            ...
                            <div className="widget quick-link-categories">
                                <h3>Categories</h3>
                                <ul>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Adventure</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Hiking &
                                        Trekking</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Cycling Tours</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Family Tours</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Wildlife Tours</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Polar Tours</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Food Tours</a></li>
                                </ul>
                            </div>
                            <!-- end quick link widget -->
                        </div>
                        <div className="col-lg-2 col-sm-4">
                            ...
                            <div className="widget quick-destinations">
                                <h3>Destinations</h3>
                                <ul>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>African Safaris</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Alaska & Canada</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>South America</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Middle East</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Asia</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>Europe</a></li>
                                    <li><a href="index.html#"><i className="fal fa-angle-right"></i>South America</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="widget contact-us">
                                <h3>Contact Us</h3>
                                <ul>
                                    <li><a href="index.html#"><i className="fal fa-paper-plane"></i>Level 1, 14-16
                                        Church Street Queenstown, New Zealand</a></li>
                                    <li><a href="index.html#"><i className="fal fa-envelope"></i>support@adventuregene.com</a>
                                    </li>
                                    <li><a href="index.html#"><i className="fal fa-phone-alt"></i>+ 001 800 661 9073</a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            ...
                            <div className="copy-payment">
                                <ul>
                                    <li><a href="index.html#"><img src="img/payment/1.png" alt=""/></a></li>
                                    <li><a href="index.html#"><img src="img/payment/2.png" alt=""/></a></li>
                                    <li><a href="index.html#"><img src="img/payment/3.png" alt=""/></a></li>
                                    <li><a href="index.html#"><img src="img/payment/4.png" alt=""/></a></li>
                                </ul>
                            </div>
                            <!-- End payment -->
                        </div>
