                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-4">
                            <div className="header-top-left">
                                <ul>
                                    <li className="has-dropdown"><a href="index-3.html#">USD</a>
                                        <ul>
                                            <li><a href="index-3.html#">URO</a></li>
                                            <li><a href="index-3.html#">FJD</a></li>
                                            <li><a href="index-3.html#">GBP</a></li>
                                        </ul>
                                    </li>
                                    <li className="has-dropdown"><a href="index-3.html#">English</a>
                                        <ul>
                                            <li><a href="index-3.html#">Arabic</a></li>
                                            <li><a href="index-3.html#">French</a></li>
                                            <li><a href="index-3.html#">Bangla</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-2 col-sm-6 col-6">
                                ...
                                <div className="site-logo">
                                    <a href="index.html"><img src="img/logo2.png" alt="GENE"/></a>
                                </div>
                                <!-- End site logo -->
                            </div>
                                ...
                                <div className="main-menu-wrap">
                                    <nav className="gene-nav">
                                        <ul className="menu">
                                            ...
                                            <li className="icon"><a href="login.html"><i className="far fa-user"></i>LOGIN</a>
                                            </li>
                                            <li className="icon"><a href="cart.html"> <i
                                                className="fal fa-shopping-basket"></i><small>(2)</small></a></li>
                                        </ul>
                                    </nav>
                                </div>
                                            ...
                                            <div className="slide-content-area">
                                                ...
                                                <div className="single-slide-content text-center">
                                                    <div className="content-text">
                                                        ...
                                                        <h2>discover the best <strong>beaches</strong> And<span></span>enjoy
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="about-content">
                                        <p>We are seasoned in this industry and are always vigilant to recognize our
                                            client’s expectations, and be on the look-out for new excursions to
                                            destinations previously inaccessible to the ordinary traveler. We have trips
                                            for everyone – from families & friends, to corporates & individuals.</p>
                                        <a href="index-3.html#" className="btn btn-theme blue-2">Get To Know Our
                                            Values</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            ...
                            <div className="single-camp-hi">
                                ...
                                <div className="camp-hi-content">
                                    <a href="index-3.html#"><h4>Cruise Tour</h4></a>
                                    <p>45 Trips</p>
                                </div>
                            </div>
                            <!-- End single camp -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-camp-hi">
                                ...
                                <div className="camp-hi-content">
                                    <a href="index-3.html#"><h4>Family Tours</h4></a>
                                    <p>127 Trips</p>
                                </div>
                            </div>
                            <!-- End single camp -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-camp-hi">
                                ...
                                <div className="camp-hi-content">
                                    <a href="index-3.html#"><h4>Water Sports</h4></a>
                                    <p>12 Games</p>
                                </div>
                            </div>
                            <!-- End single camp -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-camp-hi">
                                ...
                                <div className="camp-hi-content">
                                    <a href="index-3.html#"><h4>Beach Tours</h4></a>
                                    <p>185 Trips</p>
                                </div>
                            </div>
                            <!-- End single camp -->
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-camp-hi">
                                ...
                                <div className="camp-hi-content">
                                    <a href="index-3.html#"><h4>Beach Parties</h4></a>
                                    <p>145 Parties</p>
                                </div>
                            </div>
                            <!-- End single camp -->
                        ...
                        <div className="col-sm-6">
                            ...
                            <div className="single-camp-hi">
                                ...
                                <div className="camp-hi-content">
                                    <a href="index-3.html#"><h4>Honeymoon Tour</h4></a>
                                    <p>270 Trips</p>
                                </div>
                            </div>
                            <!-- End single camp -->
                        ...
                        <div className="col-lg-3 col-sm-6 order-three">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    ...
                                    <a href="index-3.html#"><h6>Camping At Beach</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6 order-two">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    ...
                                    <a href="index-3.html#"><h6>Dolphin Watching Day Trip</h6></a>
                            ...
                            <div className="selling-tips-wrap">
                                ...
                                <div className="single-selling-tips section-title">
                                    ...
                                    <p>It’s time to pack your bags and get ready for your next adventure. Check out the
                                        ...
                                        beautiful world.</p>
                                    <a href="index-3.html#" className="btn btn-theme blue-2 mt-30">See all the tours
                                        we're running</a>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index-3.html#"><h6>Kayak And Wild Camp</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index-3.html#"><h6>Moroccan Surf Adventure</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index-3.html#"><h6>ruise Tours</h6></a>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="single-adventure">
                                ...
                                <div className="adventure-content">
                                    <p className="tour">5 DAY TOUR</p>
                                    <a href="index-3.html#"><h6>Private Yacht tour</h6></a>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-sm-6">
                            ...
                            <div className="single-post-blog style-2">
                                ...
                                <div className="post-blog-content">
                                    <a href="index-3.html#"><h4>Five steps to picking your next destination</h4></a>
                                    <a href="index-3.html#" className="more">Read More <i
                        ...
                        <div className="col-lg-4 col-sm-6">
                            ...
                            <div className="single-post-blog style-2">
                                ...
                                <div className="post-blog-content">
                                    <a href="index-3.html#"><h4>Antarctica camping: What's it you like?</h4></a>
                                    <a href="index-3.html#" className="more">Read More <i
                                        className="fal fa-angle-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            ...
                            <div className="single-post-blog style-2">
                                ...
                                <div className="post-blog-content">
                                    <a href="index-3.html#"><h4>Road Reads: 5 books to inspire trips to Australia</h4>
                                    </a>
                                    <a href="index-3.html#" className="more">Read More <i
                                        className="fal fa-angle-right"></i></a>
                                </div>
                            ...
                            <div className="single-guide">
                                <div className="guide-thumb">
                                    ...
                                    <div className="guide-content">
                                        ...
                                        <a href="index-3.html#"><h4>Chris Kearney</h4></a>
                                        <ul>
                                            <li><a href="index-3.html#"><i className="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-twitter"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-instagram"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-youtube"></i></a></li>
                                        </ul>
                            ...
                            <div className="single-guide">
                                <div className="guide-thumb">
                                    ...
                                    <div className="guide-content">
                                        ...
                                        <a href="index-3.html#"><h4>Megan Devenish</h4></a>
                                        <ul>
                                            <li><a href="index-3.html#"><i className="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-twitter"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-instagram"></i></a></li>
                            ...
                            <div className="single-guide">
                                <div className="guide-thumb">
                                    ...
                                    <div className="guide-content">
                                        ...
                                        <a href="index-3.html#"><h4>Dan Bloomfield</h4></a>
                                        <ul>
                                            <li><a href="index-3.html#"><i className="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-twitter"></i></a></li>
                                            <li><a href="index-3.html#"><i className="fab fa-instagram"></i></a></li>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-2 col-sm-3">
                            ...
                            <div className="widget quick-link-widget">
                                <h3>Quick Links</h3>
                                <ul>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>About Us</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Why Travel With
                                        Us?</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Guides & Staff</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Contact Us</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>We Are Hiring</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Our Core
                                        Values</a></li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-2 col-sm-3">
                            ...
                            <div className="widget quick-link-categories">
                                <h3>Categories</h3>
                                <ul>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Adventure</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Hiking & Trekking</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Cycling Tours</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Family Tours</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Wildlife Tours</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Polar Tours</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Food Tours</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- end quick link widget -->
                        ...
                        <div className="col-lg-2 col-sm-4">
                            ...
                            <div className="widget quick-destinations">
                                <h3>Destinations</h3>
                                <ul>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>African
                                        Safaris</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Alaska &
                                        Canada</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>South America</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Middle East</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Asia</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>Europe</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-angle-right"></i>South America</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            ...
                            <div className="widget contact-us">
                                <h3>Contact Us</h3>
                                <ul>
                                    <li><a href="index-3.html#"><i className="fal fa-paper-plane"></i>Level 1, 14-16
                                        Church Street Queenstown, New Zealand</a></li>
                                    <li><a href="index-3.html#"><i className="fal fa-envelope"></i>support@adventuregene.com</a>
                                    </li>
                                    <li><a href="index-3.html#"><i className="fal fa-phone-alt"></i>+ 001 800 661
                                        9073</a></li>
                                </ul>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            ...
                            <div className="copy-payment">
                                <ul>
                                    <li><a href="index-3.html#"><img src="img/payment/1.png" alt=""/></a></li>
                                    <li><a href="index-3.html#"><img src="img/payment/2.png" alt=""/></a></li>
                                    <li><a href="index-3.html#"><img src="img/payment/3.png" alt=""/></a></li>
                                    <li><a href="index-3.html#"><img src="img/payment/4.png" alt=""/></a></li>
                                </ul>
                            </div>
                            <!-- End payment -->
                        </div>
