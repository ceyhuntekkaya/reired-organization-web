                ...
                <div className="row">
                    <div className="col-lg-6 col-sm-3">
                        <div className="header-top-left">
                            <ul>
                                <li className="has-dropdown"><a href="adventure-1.html#">USD</a>
                                    <ul>
                                        <li><a href="adventure-1.html#">URO</a></li>
                                        <li><a href="adventure-1.html#">FJD</a></li>
                                        <li><a href="adventure-1.html#">GBP</a></li>
                                    </ul>
                                </li>
                                <li className="has-dropdown"><a href="adventure-1.html#">Türkçe</a>
                                    <ul>
                                        <li><a href="adventure-1.html#">İngilizce</a></li>
                    ...
                    <div className="row">
                        <div className="col-lg-2 col-sm-6 col-6">
                            ...
                            <div className="site-logo">
                                <a href="index.html"><img src="img/logo4.png" alt="GENE"/></a>
                            </div>
                            ...
                            <div className="main-menu-wrap">
                                <nav className="gene-nav">
                                    <ul className="menu">
                                        ...
                                        <li className="has-dropdown"><a href="javascript:void(0)">Other
                                            Pages</a>
                                            <ul>
                                        ...
                                        <li className="icon"><a href="login.html"><i
                                            className="far fa-user"></i>LOGIN</a></li>
